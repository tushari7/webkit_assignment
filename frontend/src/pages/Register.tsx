      ...
      <div className="flex items-center justify-center p-8 md:p-12">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold tracking-tight" data-testid="register-heading">Create account</h1>
            <p className="text-muted-foreground">Get started with your project management</p>
          </div>
